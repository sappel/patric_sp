...
outputdir='/d/bhs01/boine/patric_decoh_bunch1/'   # should exist  
...
patric_dict['Z']=28.0
patric_dict['A']=238.0
patric_dict['current']=0.197*1.0  # 0.438*5.0 # 
patric_dict['piperadius']=0.05  # was 0.08
patric_dict['circum']=108.0 
patric_dict['gamma_t']=5.4
patric_dict['CF_advance_h']=97.3*pi/180.0
patric_dict['CF_advance_v']=129.3*pi/180.0 # 97.3*pi/180.0 
patric_dict['CF_R']=0.0
patric_dict['CF_length']=18.0
patric_dict['NCF']=16
patric_dict['koct']=8.0
patric_dict['dQxm']=-0.0056*0.35*1.0   # -0.0085*0.55*1.0
patric_dict['dQym']=-0.0056*0.35*1.0  # -0.0085*0.55*1.0 
...
patric_dict['init_pic_z']=3   # 1 (elliptic bunch), 0 (elliptic, coast), 2 (Gauss, coast)
patric_dict['momentum_spread']=1.0*6.0e-3   # rms
patric_dict['rms_emittance_x0']=5.0
patric_dict['rms_emittance_y0']=5.0
patric_dict['mismatch_x']=1.0
patric_dict['mismatch_y']=1.0
patric_dict['offcenter']=0.01 # 0.01 # !!! meters
patric_dict['bunchfactor']=0.35 # *1.5  
patric_dict['dqci']=0.0
patric_dict['dqcr']=-0.003
patric_dict['Rs']=0.0 # 8.5e6
patric_dict['nres']=10.0
patric_dict['Qs']=2.0 
patric_dict['leit']=1.0e5 
patric_dict['Zimage']=0.0 #-7.0e7*0.2 
patric_dict['madx_input_file']=0
patric_dict['space_charge']=2   #   0 (off), 1 (self-consistent), 2 (linear), 3 (nonlinear)
patric_dict['imp_kick']=0       #   0 (off), 1 (on) 
patric_dict['sliced']=1
patric_dict['cavity']=3   # 0 (off), 1 (rf), 2 (barrier)
patric_dict['octupole_kick']=0
patric_dict['ampdetun_kick']=0
patric_dict['chroma']=0
patric_dict['bc_end']=0    #  0 (open) , 1 (periodic)   !!!!
...
if thishost == machines[0]:  
   cmd="nohup mpirun -np %d -machinefile machines.tmp ../bin/patric %s/patric > %s/out.%s.dat &" %(num_procs,outputdir,outputdir,runid)
else:
   cmd="nohup mpirun -nolocal -np %d -machinefile machines.tmp ../bin/patric %s/patric > %s/out.%s.dat &" %(num_procs,outputdir,outputdir,runid)	  
os.system(cmd)
