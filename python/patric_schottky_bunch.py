...
outputdir='/d/bhs01/boine/patric_schottky_b_new4/'   # should exist  
runid=4                 # run identification number (only out.dat)
...
patric_dict['Z']=28.0
patric_dict['A']=238.0
patric_dict['current']=0.197*5.0  # 0.159*4.0  # 
...
patric_dict['dQxm']=-0.0056*0.35*5.0    #-0.01*0.35/2.0*5.0
patric_dict['dQym']=-0.0056*0.35*5.0    #-0.01*0.35/2.0*5.0
...
patric_dict['init_pic_z']=3   # 1 (elliptic bunch), 0 (elliptic, coast), 2 (Gauss, coast)   # was 4 !!!!
...
patric_dict['Zimage']=0.0  #+2.242e6 #  -7.0e7/5.0 # -3.0e7/2.0 
